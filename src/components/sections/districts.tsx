...
const DISTRICTS = [
  {
    ...
    image: "/images/district-gulshan-laila.jpg",
    alt: "Modern glass tower in Gulshan with a facade of stacked blue and green cubes",
  },
  {
    id: "02",
    title: "Banani & Baridhara",
    body: "Boutique residential blocks and mixed-use avenues a bridge away from the lake.",
    image: "/images/district-banani-lake.jpg",
    alt: "Banani lakefront at morning with residential towers reflected in still water",
  },
  {
    id: "03",
    title: "Hatirjheel fringe",
    body: "Lake-facing stock along the green loop — the city's most walkable waterfront.",
    image: "/images/district-hatirjheel-bridge.jpg",
    alt: "Illuminated arch bridge over Hatirjheel lake at night, reflected in the water and framed by trees",
  },
  {
    id: "04",
    title: "Emerging east",
